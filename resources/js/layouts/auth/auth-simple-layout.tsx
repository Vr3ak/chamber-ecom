...
export default function AuthSimpleLayout({
    ...
    return (
        ...
        <div className="flex min-h-svh flex-col items-center bg-mist p-6 py-10 font-display sm:py-20">
            <div className="w-full max-w-[480px] rounded-xl border border-line p-6 text-ink sm:p-10 [&_input]:h-11 [&_input]:rounded-[6px] [&_input]:border-line [&_input]:text-sm [&_input]:placeholder:text-slate [&_label]:text-[13px] [&_label]:font-medium [&_label]:text-ink">
